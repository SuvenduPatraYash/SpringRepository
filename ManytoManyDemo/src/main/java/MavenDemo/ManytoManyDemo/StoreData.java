package MavenDemo.ManytoManyDemo;
...
public class StoreData {
	public static void main(String[] args) {
		...
		StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("MavenDemo/ManytoManyDemo/hibernate.cfg.xml").build();
