...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.yash";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/SpringMvcProject-model"),
        mapper("/SpringMvcProject-dao"),
        mapperxml("/SpringMvcProject-web"),
        service("/SpringMvcProject-service"),
        web("/SpringMvcProject-web"),
        ;
